...
// UpdateContactByID provides a mock function with given fields: ctx, ID
func (_m *ContactUseCases) UpdateContactByID(ctx context.Context, ID string) (entities.Contact, error) {
	ret := _m.Called(ctx, ID)
...
// NewContactUseCases creates a new instance of ContactUseCases. It also registers a cleanup function to assert the mocks expectations.
